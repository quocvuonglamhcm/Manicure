  ...
  render() {
    ...
    return (
      <Row id='main-loi-ich' className=''>
        <Col sm={12} md={12} sx={12} className='mr-0 ml-0 mt-2 pu-litle hover-loi-ich-1'> Nail Partner mang lại</Col>
        ...
        <Col className='ml-0 mt-3 line-loi-ich-body hover-loi-ich-1' sm={1} md={1} sx={1}>
        ...
        <Col sm={5} md={5} sx={5} className='ml-0 mt-3 text-loi-ich hover-loi-ich-1'> <div className='text-loi-ich hover-zoom-1'>Khách hàng</div></Col>
{/* -------<CARD KHACH HANG></CARD> */}
        <Col sm={5} md={5} sx={5} className=' mt-2 hover-loi-ich-1 mr-0 ml-0 height-khach-hang-170px'><div className='text-loi-ich hover-zoom-1'> Thợ nails</div></Col>

        <Col className='line-loi-ich-body mt-2 hover-loi-ich' sm={1} md={1} sx={1}>
          <div className='line-loi-ich'></div>
          <div className='icon-circle margin-top-loi-ich-10'> {ic_circle}</div>
          <div className='icon-circle mt-5 '> {ic_circle}</div>
          <div className='icon-circle m-top-88 '> {ic_circle}</div>
        ...
        <Col sm={6} md={6} sx={6} className='mt-2 hover-loi-ich'>
