                            ...
                            <div className="contentBox">
                                <ol>
                                    ...
                                    <div>
                                        ...
                                        liên lạc, do bạn cung cấp cho chúng tôi, cho nhà cung cấp dịch vụ khi bạn dùng ứng dụng để đặt lịch. 
                                        ...
                                        và/hoặc theo dõi việc đặt lịch được cung cấp bởi khách hàng. Bạn, theo đây, đồng ý và trao cho chúng tôi 
                                        quyền được chia sẻ thông  tin cá nhân cho nhà cung cấp dịch vụ (nếu bạn là một khách hàng) hoặc khách hàng 
                                        (nếu bạn là một nhà cung cấp dịch vụ). Thông tin cá nhân của bạn sẽ được xóa bỏ một cách tự động khỏi ứng dụng 
                                        được sử dụng bởi nhà cung cấp dịch vụ (nếu bạn là một khách hàng) hoặc ứng dụng được sử dụng bởi khách hàng 
                                        (nếu bạn là một nhà cung cấp dịch vụ) sau khi giao dịch liên quan đến dịch vụ được hoàn tất. Tuy nhiên, 
                                        có khả năng rằng nhà cung cấp dịch vụ/khách hàng (có liên quan) có thể lưu trữ dữ liệu của bạn trong 
                                        thiết bị của họ dưới bất kỳ cách thức nào. Liên lạc giữa khách hàng và nhà cung cấp dịch vụ nằm ngoài ứng dụng 
                                        (ví dụ như liên lạc thông qua điện thoại di động hoặc tin nhắn ngắn hoặc các loại hình liên lạc khác ngoài 
                                        ứng dụng của NAIL PARTNER và/hoặc các đơn vị liên kết của NAIL PARTNER) cũng có thể được lưu trữ trên các 
                                        thiết bị có liên quan. Chúng tôi không chịu trách nhiệm cho bất cứ dữ liệu nào được lưu lại ở ngoài ứng dụng 
                                        theo các cách thức trên. Bạn đồng ý miễn trừ và giữ chúng tôi khỏi bất cứ trách nhiệm nào phát sinh liên quan tới 
                                        sự lạm dụng thông tin cá nhân của bạn bởi nhà cung cấp dịch vụ/khách hàng (có liên quan) sau khi dịch vụ hoàn tất. 
                                        ...
                                        không tiết lộ cũng như sử dụng thông tin cá nhân của  bạn cho bất kỳ mục đích nào khác. Chúng tôi có thể xóa bỏ 
                                        một phần nhất định của các thông tin cá nhân của bạn mà có thể xác định bạn (để thông tin cá nhân của bạn 
                                        trở thành ẩn danh) và tiết lộ các dữ liệu ẩn danh cho các bên thứ ba nhằm mục đích phát triển ứng dụng, quản lý 
                                        cơ sở dữ liệu, phân tích cũng như cải thiện ứng dụng. Chúng tôi có thể kết hợp thông tin cá nhân của bạn 
                                        với thông tin khác theo cách mà những thông tin này sẽ không còn liên quan tới bạn, và sau đó tiết lộ những 
                                        thông tin được kết hợp này cho bên thứ ba cho mục đích được nhắc tới ở trên.
                                    </div><br />
                                    <li>
                                        Về luật pháp:
                                    </li><br />
